...
const extraMailLocales: Record<string, any> = {
  it: {
    nav: { mailbox: "Casella" },
    mail: {
      title: "Casella",
      subtitle_unverified: "Attiva la tua casella @thegnd.io per iniziare a usarla.",
      subtitle_verified: "La tua casella @thegnd.io è attiva.",
      current: "Indirizzo attuale",
      not_set: "Non impostato",
      activate: "Attiva casella",
      activation_needed: "Attivazione richiesta",
      change_handle: "Modifica handle casella",
      handle_hint: "alfanumerico, 3–20 caratteri",
      check: "Verifica",
      save: "Salva",
      saved: "Salvato",
      available: "Handle disponibile",
      unavailable: "Handle non disponibile",
      invalid: "Handle non valido",
      activated: "Casella attivata",
      must_activate_before_change: "Attiva la casella prima di cambiare l'indirizzo.",
  ...
  pl: {
    ...
    mail: {
      title: "Skrzynka",
      subtitle_unverified: "Aktywuj swoją skrzynkę @thegnd.io, aby ją używać.",
      subtitle_verified: "Twoja skrzynka @thegnd.io jest aktywna.",
      current: "Bieżący adres",
      not_set: "Brak",
      activate: "Aktywuj skrzynkę",
      activation_needed: "Wymagana aktywacja",
      change_handle: "Zmień nazwę skrzynki",
      handle_hint: "alfanumeryczny, 3–20 znaków",
      check: "Sprawdź",
      save: "Zapisz",
      saved: "Zapisano",
      available: "Nazwa dostępna",
      unavailable: "Nazwa niedostępna",
      invalid: "Nieprawidłowa nazwa",
      activated: "Skrzynka aktywowana",
      must_activate_before_change: "Aktywuj skrzynkę przed zmianą adresu.",
      inbox: "Odebrane",
      sent: "Wysłane",
      archive: "Archiwum",
      ...
      sending: "Wysyłanie...",
      send_error: "Wysyłanie nie powiodło się",
    },
  },
  cs: {
    ...
    mail: {
      title: "Schránka",
      subtitle_unverified: "Aktivujte svou schránku @thegnd.io, abyste ji mohli používat.",
      subtitle_verified: "Vaše schránka @thegnd.io je aktivní.",
      current: "Aktuální adresa",
      not_set: "Nenastaveno",
      activate: "Aktivovat schránku",
      activation_needed: "Vyžadována aktivace",
      change_handle: "Změnit název schránky",
      handle_hint: "alfanumerický, 3–20 znaků",
      check: "Zkontrolovat",
      save: "Uložit",
      saved: "Uloženo",
      available: "Název je dostupný",
      unavailable: "Název není dostupný",
      invalid: "Neplatný název",
      activated: "Schránka aktivována",
      must_activate_before_change: "Nejprve aktivujte schránku.",
      inbox: "Doručené",
      sent: "Odeslané",
      archive: "Archiv",
      unread: "Nepřečtené",
      ...
      sending: "Odesílání...",
      send_error: "Odeslání selhalo",
    },
  },
  hu: {
    nav: { mailbox: "Postafiók" },
    mail: {
      title: "Postafiók",
      subtitle_unverified: "Aktiváld a @thegnd.io postafiókodat a használathoz.",
      subtitle_verified: "A @thegnd.io postafiókod aktív.",
      current: "Jelenlegi cím",
      not_set: "Nincs beállítva",
      activate: "Postafiók aktiválása",
      activation_needed: "Aktiválás szükséges",
      change_handle: "Postafiók azonosító módosítása",
      handle_hint: "alfanumerikus, 3–20 karakter",
      check: "Ellenőrzés",
      save: "Mentés",
      saved: "Mentve",
      available: "Azonosító elérhető",
      unavailable: "Azonosító nem elérhető",
      invalid: "Érvénytelen azonosító",
      activated: "Postafiók aktiválva",
      must_activate_before_change: "Először aktiváld a postafiókot.",
      inbox: "Beérkezett",
      sent: "Elküldött",
      archive: "Archívum",
      unread: "Olvasatlan",
      ...
      sending: "Küldés...",
      send_error: "Küldés sikertelen",
    },
  },
  ro: {
    nav: { mailbox: "Căsuță poștală" },
    mail: {
      title: "Căsuță poștală",
      subtitle_unverified: "Activează căsuța @thegnd.io pentru a o folosi.",
      subtitle_verified: "Căsuța @thegnd.io este activă.",
      current: "Adresă curentă",
      not_set: "Nesetat",
      activate: "Activează căsuța",
      activation_needed: "Necesită activare",
      change_handle: "Schimbă numele căsuței",
      handle_hint: "alfanumeric, 3–20 caractere",
      check: "Verifică",
      save: "Salvează",
      saved: "Salvat",
      available: "Nume disponibil",
      unavailable: "Nume indisponibil",
      invalid: "Nume invalid",
      activated: "Căsuță activată",
      must_activate_before_change: "Activează mai întâi căsuța.",
      inbox: "Inbox",
      sent: "Trimise",
      archive: "Arhivă",
      unread: "Necitite",
      ...
      sending: "Se trimite...",
      send_error: "Trimitere eșuată",
    },
  },
};

try {
  Object.keys(extraMailLocales).forEach((lng) => {
    i18n.addResourceBundle(lng, "translation", extraMailLocales[lng], true, true);
  });
} catch {}
