...
const resources = {
  en: {
    translation: {
      ...
      mail: {
        title: "Mailbox",
        subtitle_unverified: "Activate your @thegnd.io mailbox to start using it.",
        subtitle_verified: "Your @thegnd.io mailbox is active.",
        current: "Current address",
        not_set: "Not set",
        activate: "Activate mailbox",
        activation_needed: "Activation required",
        change_handle: "Change mailbox handle",
        handle_hint: "alphanumeric, 3–20 chars",
        check: "Check",
        save: "Save",
        saved: "Saved",
        available: "Handle is available",
        unavailable: "Handle is not available",
        invalid: "Invalid handle",
        activated: "Mailbox activated",
        must_activate_before_change: "Please activate your mailbox before changing the address.",
        inbox: "Inbox",
        unread: "Unread",
        all: "All",
  ...
  de: { translation: {
    ...
    nav: { home: "Startseite", explore: "Entdecken", mailbox: "Mailbox", messages: "Nachrichten", favorites: "Favoriten", profile: "Mein Profil", settings: "Einstellungen", premium: "Premium werden" },
    ...
    mail: {
      title: "Mailbox",
      subtitle_unverified: "Aktiviere deine @thegnd.io Mailbox, um sie zu nutzen.",
      subtitle_verified: "Deine @thegnd.io Mailbox ist aktiv.",
      current: "Aktuelle Adresse",
      not_set: "Nicht gesetzt",
      activate: "Mailbox aktivieren",
      activation_needed: "Aktivierung erforderlich",
      change_handle: "Mailbox-Handle ändern",
      handle_hint: "alphanumerisch, 3–20 Zeichen",
      check: "Prüfen",
      save: "Speichern",
      saved: "Gespeichert",
      available: "Handle ist verfügbar",
      unavailable: "Handle ist nicht verfügbar",
      invalid: "Ungültiges Handle",
      activated: "Mailbox aktiviert",
      must_activate_before_change: "Bitte aktiviere zuerst deine Mailbox, bevor du die Adresse änderst.",
      inbox: "Posteingang",
      unread: "Ungelesen",
      all: "Alle",
  ...
  es: { translation: {
    ...
    nav: { home: "Inicio", explore: "Explorar", mailbox: "Buzón", messages: "Mensajes", favorites: "Favoritos", profile: "Mi perfil", settings: "Ajustes", premium: "Hazte Premium" },
  ...
  fr: { translation: {
    ...
    nav: { home: "Accueil", explore: "Explorer", mailbox: "Boîte mail", messages: "Messages", favorites: "Favoris", profile: "Mon profil", settings: "Paramètres", premium: "Passer Premium" },
